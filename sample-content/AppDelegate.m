...
const NSUInteger kApplicationID = 51818;
NSString *const kAuthKey        = @"jrm7UrNjVsH58jC";
NSString *const kAuthSecret     = @"OhWhJWKJA78nOhV";
NSString *const kAccountKey     = @"yr9pqKqLy5cf8GACsFLx";
